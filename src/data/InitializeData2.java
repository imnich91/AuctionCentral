...
public class InitializeData2 {	
	...
	public static void main(String [] args) {
		...
		myCalendar.addAuction(new AuctionRequest(new Date(20, "December", 2016), 
				new Time(6, 00, "PM"), myNonProfit11.getOrgName()));	
		
		myCalendar.addAuction(new AuctionRequest(new Date(20, "December", 2016), 
				new Time(2, 00, "PM"), myNonProfit12.getOrgName()));	
		
		myCalendar.addAuction(new AuctionRequest(new Date(21, "December", 2016), 
		...
		myCalendar.addAuction(new AuctionRequest(new Date(23, "December", 2016), 
				new Time(2, 00, "PM"), myNonProfit15.getOrgName()));	
		
		myCalendar.addAuction(new AuctionRequest(new Date(23, "December", 2016), 
				new Time(6, 00, "PM"), myNonProfit16.getOrgName()));	
		
		myCalendar.addAuction(new AuctionRequest(new Date(24, "December", 2016), 
				new Time(2, 00, "PM"), myNonProfit17.getOrgName()));	
		
		myCalendar.addAuction(new AuctionRequest(new Date(24, "December", 2016), 
				new Time(6, 00, "PM"), myNonProfit18.getOrgName()));	
		
		myCalendar.addAuction(new AuctionRequest(new Date(25, "December", 2016), 
				new Time(2, 00, "PM"), myNonProfit19.getOrgName()));	
		
		myCalendar.addAuction(new AuctionRequest(new Date(25, "December", 2016), 
				new Time(6, 00, "PM"), myNonProfit20.getOrgName()));	
		
		myCalendar.addAuction(new AuctionRequest(new Date(26, "December", 2016), 
				new Time(2, 00, "PM"), myNonProfit21.getOrgName()));
		
		myCalendar.addAuction(new AuctionRequest(new Date(26, "December", 2016), 
				new Time(6, 00, "PM"), myNonProfit22.getOrgName()));	
		
		myCalendar.addAuction(new AuctionRequest(new Date(27, "December", 2016), 
				new Time(2, 00, "PM"), myNonProfit23.getOrgName()));	
		
		myCalendar.addAuction(new AuctionRequest(new Date(27, "December", 2016), 
				new Time(6, 00, "PM"), myNonProfit24.getOrgName()));	
		
		myCalendar.addAuction(new AuctionRequest(new Date(28, "December", 2016), 
				new Time(1, 00, "PM"), myNonProfit25.getOrgName()));	
